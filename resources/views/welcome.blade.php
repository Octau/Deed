    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            @endif
                 ...
                 <!-- Page Content -->
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 my-64 ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="table_content">
                            @foreach ($projects as $project)
                                <tr scope="row">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" align="center">{{ $project->name}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" align="center">
                                        <a href="{{"https://wa.me/".$project->contact_number}}">
                                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">CONTACT ME</button>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
